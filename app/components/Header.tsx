            ...
            <div className="flex flex-col w-full my-10 space-y-5">
              <Accordion type="single" collapsible className="w-full space-y-5">
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className={navigationMenuTriggerStyle()}>Služby pre podnikateľov</AccordionTrigger>
                  <AccordionContent>
                    <div className="flex flex-col">
                      ...
                      <div className="flex w-full flex-nowrap">
                        <Link to="/sluzby/danove-pravo" className={`grow text-center ${navigationMenuTriggerStyle()}`}>
                          Daňové právo
                        </Link>
                      </div>
                      <div className="flex w-full flex-nowrap">
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    <div className="flex flex-col">
                      ...
                      <div className="flex w-full flex-nowrap">
                        <Link to="/sluzby/spravne-pravo" className={`grow text-center ${navigationMenuTriggerStyle()}`}>
                          SPRÁVNE PRÁVO
                        </Link>
                      </div>
                    </div>
